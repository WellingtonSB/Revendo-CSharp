...
// Type: TopData.GerenciadorRep.Bi.Dominio.NotificarStatusImpressoraRepPlusEventArgs
...
{
  public class NotificarStatusImpressoraRepPlusEventArgs : EventArgs
  {
    private ResultadoStatusImpressora _resultado = new ResultadoStatusImpressora();

    public NotificarStatusImpressoraRepPlusEventArgs(
      int repID,
      string rep_desc,
      int grupoRep,
      ...
      Constantes.STATUS_IMPRESSORA_REP_PLUS statusImpressora2,
      Constantes.STATUS_PROCESSO_VERIFICA_IMPRESSORA statusProcesso)
    {
      ...
      this._resultado.StatusImpressoraRepPlus2 = statusImpressora2;
