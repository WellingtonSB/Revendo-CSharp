...
// Type: TopData.GerenciadorRep.Bi.Dominio.RegistroAFD
...
namespace TopData.GerenciadorRep.Bi.Dominio
{
  public class RegistroAFD
  {
      ...
      RepAFD _repAFD)
    {
      ...
      byte[] arrayEmpresa = new byte[274];
      byte[] arrayEmpregado = new byte[69];
      byte[] arrayAjusteRTC = new byte[15];
      ...
      while (sourceIndex < byteArrayAux.Length && ultimoNSRREP > ultimoNSRProcessado)
      {
        if (byteArrayAux[sourceIndex] == (byte) 163)
        {
          if (sourceIndex + 16 <= byteArrayAux.Length)
          {
            ...
            registroAfdList.Add(RegistroAFD.TratarRegistroMarcacao(arrayMarcacao));
        ...
        {
          if (sourceIndex + 69 <= byteArrayAux.Length)
          {
            Array.Copy((Array) byteArrayAux, sourceIndex, (Array) arrayEmpregado, 0, 69);
            registroAfdList.Add(RegistroAFD.TratarRegistroEmpregado(arrayEmpregado));
            ultimoNSRProcessado = registroAfdList[registroAfdList.Count - 1].NSR;
        ...
        {
          if (sourceIndex + 274 <= byteArrayAux.Length)
          {
            Array.Copy((Array) byteArrayAux, sourceIndex, (Array) arrayEmpresa, 0, 274);
            registroAfdList.Add(RegistroAFD.TratarRegistroEmpresa(arrayEmpresa));
            ultimoNSRProcessado = registroAfdList[registroAfdList.Count - 1].NSR;
        ...
        {
          if (sourceIndex + 15 <= byteArrayAux.Length)
          {
            Array.Copy((Array) byteArrayAux, sourceIndex, (Array) arrayAjusteRTC, 0, 15);
            registroAfdList.Add(RegistroAFD.TratarRegistroAjusteRTC(arrayAjusteRTC));
            ultimoNSRProcessado = registroAfdList[registroAfdList.Count - 1].NSR;
        ...
        else if (byteArrayAux[sourceIndex] == (byte) 166)
        {
          if (sourceIndex + 12 <= byteArrayAux.Length)
          {
            ...
            registroAfdList.Add(RegistroAFD.TratarRegistroEventosSensiveis(arrayEventosSensiveis));
            ultimoNSRProcessado = registroAfdList[registroAfdList.Count - 1].NSR;
    ...
    internal static RegistroAFD TratarRegistroEmpresa(byte[] arrayEmpresa)
    {
      ...
      stringBuilder2.Append(numArray2[0].ToString().PadLeft(2, '0'));
      stringBuilder2.Append(numArray2[1].ToString().PadLeft(2, '0'));
      stringBuilder2.Append("20");
      stringBuilder2.Append(numArray2[2].ToString().PadLeft(2, '0'));
      stringBuilder2.Append(numArray2[3].ToString().PadLeft(2, '0'));
      stringBuilder2.Append(numArray2[4].ToString().PadLeft(2, '0'));
      Array.Reverse((Array) numArray2, 0, 3);
      for (int index = 0; index < numArray2.Length; ++index)
        registroAfd.dtRegistro += numArray2[index].ToString().PadLeft(2, '0');
      ...
      stringBuilder3.Append(num.ToString());
    ...
    internal static RegistroAFD TratarRegistroEmpregado(byte[] arrayEmpregado)
    {
      ...
      stringBuilder3.Append((object) stringBuilder2);
      stringBuilder3.Append(((char) num).ToString());
      stringBuilder3.Append(stringBuilder4.ToString());
    ...
    internal static RegistroAFD TratarRegistroAjusteRTC(byte[] arrayAjusteRTC)
    {
      ...
      stringBuilder1.Append(numArray2[0].ToString().PadLeft(2, '0'));
      stringBuilder1.Append(numArray2[1].ToString().PadLeft(2, '0'));
      stringBuilder1.Append("20");
      stringBuilder1.Append(numArray2[2].ToString().PadLeft(2, '0'));
      stringBuilder1.Append(numArray2[3].ToString().PadLeft(2, '0'));
      stringBuilder1.Append(numArray2[4].ToString().PadLeft(2, '0'));
      Array.Reverse((Array) numArray2, 0, 3);
      for (int index = 0; index < numArray2.Length; ++index)
        registroAfd.dtRegistro += numArray2[index].ToString().PadLeft(2, '0');
      Array.Copy((Array) arrayAjusteRTC, 10, (Array) numArray3, 0, 5);
      stringBuilder2.Append(numArray3[0].ToString().PadLeft(2, '0'));
      stringBuilder2.Append(numArray3[1].ToString().PadLeft(2, '0'));
      stringBuilder2.Append("20");
      stringBuilder2.Append(numArray3[2].ToString().PadLeft(2, '0'));
      stringBuilder2.Append(numArray3[3].ToString().PadLeft(2, '0'));
      stringBuilder2.Append(numArray3[4].ToString().PadLeft(2, '0'));
    ...
    public static int GravarRegistrosColetaAFD(List<RegistroAFD> listaRegistrosAFD, RepAFD _repAFD)
    {
      new RegistroAFD().GravarRegistrosAFDUnificado(listaRegistrosAFD, _repAFD);
      return 0;
    }

    public static int GravarRegistrosColetaAFDComTransacao(
      List<RegistroAFD> listaRegistrosAFD,
      RepAFD _repAFD)
    {
      int num = 0;
      try
      {
        return new RegistroAFD().GravarRegistrosAFDUnificadoComTransacao(listaRegistrosAFD, _repAFD);
      }
      catch (Exception ex)
      {
        num = -1;
    ...
    public static List<RegistroAFD> PesquisarTodosOsRegistrosColetaAFD(RepAFD _repAFD) => new RegistroAFD().PesquisarTodosOsRegistrosColetaAFD(_repAFD);

    public static List<RegistroAFD> PesquisarTodosOsRegistrosAFD(
      RepAFD _repAFD,
      ParametrosExportacaoAFD paramExport)
    {
      return new RegistroAFD().PesquisarTodosOsRegistrosAFD(_repAFD, paramExport);
    }

    public static List<RegistroAFD> PesquisarTodosOsRegistrosColetaAFD(
      RepAFD _repAFD,
      ParametrosExportacaoAFD paramExport)
    {
      return new RegistroAFD().PesquisarTodosOsRegistrosColetaAFD(_repAFD, paramExport);
    }

    public static List<RegistroAFD> PesquisarTodosOsRegistrosREST(
      RepAFD _repAFD,
      ParametrosExportacaoAFD paramExport)
    {
      return new RegistroAFD().PesquisarTodosOsRegistrosREST(_repAFD, paramExport);
    }
    ...
    public static RegistroAFD PesquisarRegistroMaiorDataColetaAFD(RepAFD _repAFD) => new RegistroAFD().PesquisarRegistroMaiorDataColetaAFD(_repAFD);

    public static RegistroAFD PesquisarRegistroMaiorDataColetaAFD(
      RepAFD _repAFD,
      ParametrosExportacaoAFD paramExport)
    {
      return new RegistroAFD().PesquisarRegistroMaiorDataColetaAFD(_repAFD, paramExport);
    }

    public static RegistroAFD PesquisarRegistroMenorDataColetaAFD(RepAFD _repAFD) => new RegistroAFD().PesquisarRegistroMenorDataColetaAFD(_repAFD);

    public static RegistroAFD PesquisarRegistroMenorDataColetaAFD(
      RepAFD _repAFD,
      ParametrosExportacaoAFD paramExport)
    {
      return new RegistroAFD().PesquisarRegistroMenorDataColetaAFD(_repAFD, paramExport);
    }

    public static RegistroAFD PesquisarUltimoRegistroEmpresaColetaAFD(RepAFD _repAFD) => new RegistroAFD().PesquisarUltimoRegistroEmpresaColetaAFD(_repAFD);
    ...
    public bool ExisteRegistrosEnviadoNuvem(RepAFD objRepAfd)
    {
      try
      {
        return new RegistroAFD().PesquisarRegistrosEnviadoNuvem(objRepAfd).Count > 0;
      }
      catch (Exception ex)
      {
        return false;
    ...
    public static int PesquisarUltimoEnvioNuvem(int repId)
    {
      try
      {
        return new RegistroAFD().PesquisarUltimoEnvioNuvem(RepAFD.PesquisarRepAFDPorREP(repId)).NSR;
      }
      catch
      {
      }
...
label_22:
      while (index1 < byteArrayAux.Length && !flag3)
      {
        if (byteArrayAux[index1] != (byte) 0)
          flag2 = false;
        if (byteArrayAux[index1] == (byte) 163 || byteArrayAux[index1] == (byte) 165 || byteArrayAux[index1] == (byte) 162 || byteArrayAux[index1] == (byte) 164)
        {
          flag3 = true;
      ...
      while (sourceIndex < byteArrayAux.Length)
      {
        try
        {
          if (byteArrayAux[sourceIndex] == (byte) 163)
          {
            ...
            {
              Array.Copy((Array) byteArrayAux, sourceIndex, (Array) arrayMarcacao, 0, 16);
              registroAfd = RegistroAFD.TratarRegistroMarcacao(arrayMarcacao);
              break;
            }
            sourceIndex += 16;
          }
          else if (byteArrayAux[sourceIndex] == (byte) 165)
          {
            ...
            {
              Array.Copy((Array) byteArrayAux, sourceIndex, (Array) arrayEmpregado, 0, 69);
              registroAfd = RegistroAFD.TratarRegistroEmpregado(arrayEmpregado);
              break;
            }
            sourceIndex += 69;
          }
          else if (byteArrayAux[sourceIndex] == (byte) 162)
          {
            ...
            {
              Array.Copy((Array) byteArrayAux, sourceIndex, (Array) arrayEmpresa, 0, 274);
              registroAfd = RegistroAFD.TratarRegistroEmpresa(arrayEmpresa);
              break;
            }
            sourceIndex += 274;
          }
          else if (byteArrayAux[sourceIndex] == (byte) 164)
          {
            ...
            {
              Array.Copy((Array) byteArrayAux, sourceIndex, (Array) arrayAjusteRTC, 0, 15);
              registroAfd = RegistroAFD.TratarRegistroAjusteRTC(arrayAjusteRTC);
              break;
            }
            sourceIndex += 15;
          }
